...
namespace SoulCore.Data.Bin.Table.Entities
{
    ...
    public sealed class CharacterInfoEntity : ITableEntity<KeyType>
    {
        ...
        public CharacterInfoEntity(BinaryReader br)
        {
            ...
            Unknown2 = br.ReadCharacterLengthUnicodeString();
            Unknown3 = br.ReadCharacterLengthUnicodeString();
            DialogueTalkImgPath = br.ReadCharacterLengthUnicodeString();
            Token = br.ReadCharacterLengthUnicodeString();
            Unknown4 = br.ReadCharacterLengthUnicodeString();
            CutScenePath = br.ReadCharacterLengthUnicodeString();
            GhostTalkImgPath = br.ReadCharacterLengthUnicodeString();
