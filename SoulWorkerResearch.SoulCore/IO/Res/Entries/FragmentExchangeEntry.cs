global using FragmentExchangeKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class FragmentExchangeEntry : IEntry<FragmentExchangeEntry>
{
    public const string TableName = "tb_Fragment_Exchange";

    public FragmentExchangeKeyType Id { get; set; }
    ...
    public FragmentExchangeEntry(BinaryReader reader)
    {
    ...
    static string IEntry<FragmentExchangeEntry>.TableName => TableName;

    static FragmentExchangeEntry IEntry<FragmentExchangeEntry>.CreateInstance(BinaryReader reader)
    {
        return new FragmentExchangeEntry(reader);
    }
}
