global using SpecialOptionChangeKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class SpecialOptionChangeEntry : IEntry<SpecialOptionChangeEntry>
{
    public const string TableName = "tb_Special_Option_Change";

    public SpecialOptionChangeKeyType Id { get; set; }
    ...
    public SpecialOptionChangeEntry(BinaryReader reader)
    {
    ...
    static string IEntry<SpecialOptionChangeEntry>.TableName => TableName;

    static SpecialOptionChangeEntry IEntry<SpecialOptionChangeEntry>.CreateInstance(BinaryReader reader)
    {
        return new SpecialOptionChangeEntry(reader);
    }
}
