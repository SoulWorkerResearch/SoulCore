global using SpeechPcJKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class SpeechPcJEntry : IEntry<SpeechPcJEntry>
{
    public const string TableName = "tb_Speech_PC_J";

    public SpeechPcJKeyType Id { get; set; }
    ...
    public SpeechPcJEntry(BinaryReader reader)
    {
    ...
    static string IEntry<SpeechPcJEntry>.TableName => TableName;

    static SpeechPcJEntry IEntry<SpeechPcJEntry>.CreateInstance(BinaryReader reader)
    {
        return new SpeechPcJEntry(reader);
    }
}
