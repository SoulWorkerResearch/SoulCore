global using CustomizeEyesKeyType = System.Byte;
...
[Table(TableName)]
public sealed class CustomizeEyesEntry : IEntry<CustomizeEyesEntry>
{
    public const string TableName = "tb_Customize_Eyes";

    public CustomizeEyesKeyType Id { get; set; }
    ...
    public CustomizeEyesEntry(BinaryReader reader)
    {
        Id = reader.ReadByte();
    ...
    static string IEntry<CustomizeEyesEntry>.TableName => TableName;

    static CustomizeEyesEntry IEntry<CustomizeEyesEntry>.CreateInstance(BinaryReader reader)
    {
        return new CustomizeEyesEntry(reader);
    }
}
