global using SpeechPcDKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class SpeechPcDEntry : IEntry<SpeechPcDEntry>
{
    public const string TableName = "tb_Speech_PC_D";

    public SpeechPcDKeyType Id { get; set; }
    ...
    public SpeechPcDEntry(BinaryReader reader)
    {
    ...
    static string IEntry<SpeechPcDEntry>.TableName => TableName;

    static SpeechPcDEntry IEntry<SpeechPcDEntry>.CreateInstance(BinaryReader reader)
    {
        return new SpeechPcDEntry(reader);
    }
}
