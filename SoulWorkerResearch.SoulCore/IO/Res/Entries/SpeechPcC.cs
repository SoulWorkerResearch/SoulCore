global using SpeechPcCKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class SpeechPcCEntry : IEntry<SpeechPcCEntry>
{
    public const string TableName = "tb_Speech_PC_C";

    public SpeechPcCKeyType Id { get; set; }
    ...
    public SpeechPcCEntry(BinaryReader reader)
    {
    ...
    static string IEntry<SpeechPcCEntry>.TableName => TableName;

    static SpeechPcCEntry IEntry<SpeechPcCEntry>.CreateInstance(BinaryReader reader)
    {
        return new SpeechPcCEntry(reader);
    }
}
