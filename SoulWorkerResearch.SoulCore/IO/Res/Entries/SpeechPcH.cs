global using SpeechPcHKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class SpeechPcHEntry : IEntry<SpeechPcHEntry>
{
    public const string TableName = "tb_Speech_PC_H";

    public SpeechPcHKeyType Id { get; set; }
    ...
    public SpeechPcHEntry(BinaryReader reader)
    {
    ...
    static string IEntry<SpeechPcHEntry>.TableName => TableName;

    static SpeechPcHEntry IEntry<SpeechPcHEntry>.CreateInstance(BinaryReader reader)
    {
        return new SpeechPcHEntry(reader);
    }
}
