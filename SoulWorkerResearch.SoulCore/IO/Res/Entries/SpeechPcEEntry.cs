global using SpeechPcEKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class SpeechPcEEntry : IEntry<SpeechPcEEntry>
{
    public const string TableName = "tb_Speech_PC_E";

    public SpeechPcEKeyType Id { get; set; }
    ...
    public SpeechPcEEntry(BinaryReader reader)
    {
    ...
    static string IEntry<SpeechPcEEntry>.TableName => TableName;

    static SpeechPcEEntry IEntry<SpeechPcEEntry>.CreateInstance(BinaryReader reader)
    {
        return new SpeechPcEEntry(reader);
    }
}
