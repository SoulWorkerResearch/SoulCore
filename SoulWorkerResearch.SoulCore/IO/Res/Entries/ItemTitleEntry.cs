global using ItemTitleKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class ItemTitleEntry : IEntry<ItemTitleEntry>
{
    public const string TableName = "tb_item_title";

    public ItemTitleKeyType Id { get; set; }
    ...
    public ItemTitleEntry(BinaryReader reader)
    {
    ...
    static string IEntry<ItemTitleEntry>.TableName => TableName;

    static ItemTitleEntry IEntry<ItemTitleEntry>.CreateInstance(BinaryReader reader)
    {
        return new ItemTitleEntry(reader);
    }
}
