global using SpeechPcFKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class SpeechPcFEntry : IEntry<SpeechPcFEntry>
{
    public const string TableName = "tb_Speech_PC_F";

    public SpeechPcFKeyType Id { get; set; }
    ...
    public SpeechPcFEntry(BinaryReader reader)
    {
    ...
    static string IEntry<SpeechPcFEntry>.TableName => TableName;

    static SpeechPcFEntry IEntry<SpeechPcFEntry>.CreateInstance(BinaryReader reader)
    {
        return new SpeechPcFEntry(reader);
    }
}
