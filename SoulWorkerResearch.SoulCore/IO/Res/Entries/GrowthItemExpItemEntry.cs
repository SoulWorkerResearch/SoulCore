global using GrowthItemExpItemKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class GrowthItemExpItemEntry : IEntry<GrowthItemExpItemEntry>
{
    public const string TableName = "tb_Growth_Item_Exp_Item";

    public GrowthItemExpItemKeyType Id { get; set; }
    ...
    public GrowthItemExpItemEntry(BinaryReader reader)
    {
    ...
    static string IEntry<GrowthItemExpItemEntry>.TableName => TableName;

    static GrowthItemExpItemEntry IEntry<GrowthItemExpItemEntry>.CreateInstance(BinaryReader reader)
    {
        return new GrowthItemExpItemEntry(reader);
    }
}
