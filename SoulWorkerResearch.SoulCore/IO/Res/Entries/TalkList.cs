global using TalkListKeyType = System.UInt16;
...
[Table(TableName)]
public sealed class TalkListEntry : IEntry<TalkListEntry>
{
    public const string TableName = "tb_Talk_List";

    public TalkListKeyType Id { get; set; }
    ...
    public TalkListEntry(BinaryReader reader)
    {
    ...
    static string IEntry<TalkListEntry>.TableName => TableName;

    static TalkListEntry IEntry<TalkListEntry>.CreateInstance(BinaryReader reader)
    {
        return new TalkListEntry(reader);
    }
}
