global using SpeechPcIKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class SpeechPcIEntry : IEntry<SpeechPcIEntry>
{
    public const string TableName = "tb_Speech_PC_I";

    public SpeechPcIKeyType Id { get; set; }
    ...
    public SpeechPcIEntry(BinaryReader reader)
    {
    ...
    static string IEntry<SpeechPcIEntry>.TableName => TableName;

    static SpeechPcIEntry IEntry<SpeechPcIEntry>.CreateInstance(BinaryReader reader)
    {
        return new SpeechPcIEntry(reader);
    }
}
