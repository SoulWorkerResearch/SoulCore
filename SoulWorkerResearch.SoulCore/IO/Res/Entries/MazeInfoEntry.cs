...
[Table(TableName)]
public sealed record MazeInfoEntry : ITableEntry<MazeInfoKeyType>
{
    public const string TableName = "tb_Maze_Info";

    public MazeInfoKeyType Id { get; }
    ...
    public MazeInfoEntry(BinaryReader br)
    {
        Id = br.ReadUInt16();
        Type = br.ReadByte();
        ...
        Batch = br.ReadUTF16UnicodeString();
        Unknown31 = br.ReadUTF16UnicodeString();
        LuaScript = br.ReadUTF16UnicodeString();
        BGMMaze = br.ReadUTF16UnicodeString();
        BGMBoss = br.ReadUTF16UnicodeString();
        Map = br.ReadUTF16UnicodeString();
        Unknown36 = br.ReadUInt16();
        Unknown37 = br.ReadUInt16();
        Unknown38 = br.ReadByte();
        Unknown39 = br.ReadUInt16();
        LoadingBackground = br.ReadUTF16UnicodeString();
        Unknown41 = br.ReadUTF16UnicodeString();
        ...
        Unknown54 = br.ReadUTF16UnicodeString();
...
// https://youtu.be/l74Ot_2kuNs (2:34)
