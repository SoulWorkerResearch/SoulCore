global using QuestConditionKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class QuestConditionEntry : IEntry<QuestConditionEntry>
{
    public const string TableName = "tb_Quest_Condition";

    public QuestConditionKeyType Id { get; set; }
    ...
    public QuestConditionEntry(BinaryReader reader)
    {
    ...
    static string IEntry<QuestConditionEntry>.TableName => TableName;

    static QuestConditionEntry IEntry<QuestConditionEntry>.CreateInstance(BinaryReader reader)
    {
        return new QuestConditionEntry(reader);
    }
}
