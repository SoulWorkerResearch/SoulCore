global using SpeechPcAKeyType = System.UInt32;
...
[Table(TableName)]
public sealed class SpeechPcAEntry : IEntry<SpeechPcAEntry>
{
    public const string TableName = "tb_Speech_PC_A";

    public SpeechPcAKeyType Id { get; set; }
    ...
    public SpeechPcAEntry(BinaryReader reader)
    {
    ...
    static string IEntry<SpeechPcAEntry>.TableName => TableName;

    static SpeechPcAEntry IEntry<SpeechPcAEntry>.CreateInstance(BinaryReader reader)
    {
        return new SpeechPcAEntry(reader);
    }
}
