...
namespace SoulWorkerResearch.SoulCore.IO.Datas.Bin.Table.Entities
{
    ...
    public sealed class ItemEntity : ITableEntity<KeyType>
    {
        ...
        {
            IEnumerable<byte> classes = br.ReadByteEnumerable(CommonDefines.PerItemStatsCount);
            IEnumerable<uint> types = br.ReadUInt32Enumerable(CommonDefines.PerItemStatsCount);
            IEnumerable<int> values = br.ReadInt32Enumerable(CommonDefines.PerItemStatsCount);
