...
namespace SoulWorkerResearch.SoulCore.IO.Network.PacketSharedStructure
{
    public readonly struct CharacterPacketSharedStructure
    {
        ...
        public readonly struct CostumeInfos
        {
            ...
            {
                (CostumeInfo Battle, CostumeInfo View)[]? items = Enumerable.Range(0, CommonDefines.EquipableFashionStorageMaxCapacity).Select(_ => (Battle: new CostumeInfo(br), View: new CostumeInfo(br))).ToArray();
